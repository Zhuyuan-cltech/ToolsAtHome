...
# 定义模板目录（根据实际路径调整）
TEMPLATE_DIR_I32="/workspace/iree/tests/e2e/dlc_specific/test_set/aten_ops/Ctlz"
TEMPLATE_DIR_F32="/workspace/iree/tests/e2e/dlc_specific/test_set/aten_ops/Sin"
TEMPLATE_DIR_F32_F32="/workspace/iree/tests/e2e/dlc_specific/test_set/aten_ops/Atan2"
TEMPLATE_DIR_I32_I32="/workspace/iree/tests/e2e/dlc_specific/test_set/aten_ops/Ipowi"
...
TEMPLATE_DIR_F32_F32_F32="/workspace/iree/tests/e2e/dlc_specific/test_set/aten_ops/Fma"
...
"fff") TEMPLATE_DIR="$TEMPLATE_DIR_F32_F32_F32" ;;
*)
  echo "错误：未配置的mode参数"
  exit 1
  ;;
...
# 替换操作符和标识符（修复换行符和变量）
sed -i.bak \
  -e "s/math\.${TEMPLATE_OP_LOWER}/math.${OP_NAME,,}/g" \
